# Miner Commit - ab-sniffer

This is a miner commit API example for ab-sniffer.
...
```sh
docker build -t myhub/rest-abs-commit:0.0.1 .

# For MacOS (Apple Silicon) to build AMD64:
DOCKER_BUILDKIT=1 docker build --platform linux/amd64 -t myhub/rest-abs-commit:0.0.1 .
```
